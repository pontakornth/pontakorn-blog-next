  ...
  return (
    <>
      ...
      <Container>
        ...
        <p tw="text-2xl">I am a software engineer student.</p>
        <Section>
          <H2 tw="text-5xl">About me</H2>
          <div tw="space-y-4 text-lg text-left">
            <p>
              Hello, I am Pontakorn. You can call me Most. I am a frontend
              developer and sometimes backend as well.
            </p>
            <p>
              I love to apply knowledge I learned in project and seek new area
              to learn.
            </p>
          </div>
        </Section>
        <Section>
          ...
          <div tw="flex flex-row gap-3 py-4 flex-wrap justify-center">
            {technologies.map((tech) => (
              <Button variant="tech" as="div" cursor="default">
                {tech}
              </Button>
            ))}
          </div>
        ...
        <Section>
          ...
          <div tw="space-y-4">
            <p>
              You can mail{" "}
              <a
                tw="text-primary hover:text-blue-600"
                href="mailto:pontakorn_most@outlook.com"
              >
                pontakorn_most@outlook.com
              </a>{" "}
            ...
            <div tw="flex flex-col items-center gap-3">
              <Button
                as="a"
                target="__blank"
                tw="bg-gray-700 text-white font-bold w-2/3 md:w-1/4"
              ...
              <Button
                as="a"
                target="__blank"
                tw="border text-white bg-primary dark:(text-primary bg-white) font-bold w-2/3 md:w-1/4"
                href="mailto:pontakorn_most@outlook.com"
              >
